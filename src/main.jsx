import { BarChart3, Home, Plus, Settings, Trash2, Wallet } from 'lucide-react';
        ...
        {tab === 'accounts' && (
          <section>
            <div className="card">
              ...
              {holdings.length === 0 ? <p className="empty">아직 추가된 ETF가 없습니다.</p> : holdings.map(h => (
                <div className="holding" key={h.id}>
                  ...
                  <p>수익률 {h.avgPrice && h.currentPrice ? (((h.currentPrice - h.avgPrice) / h.avgPrice) * 100).toFixed(2) + '%' : '-'}</p>
                  ...
                  <div className="right">
                    ...
                    <button onClick={() => removeHolding(h.id)}><Trash2 size={16}/></button>
                  </div>
                </div>
              ))}
            </div>
